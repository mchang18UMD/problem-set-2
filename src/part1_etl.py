...
def ETL():
    ...
    pred_universe_raw.to_csv('data/pred_universe_raw.csv', index=False) # Save csv to data folder
    arrest_events_raw.to_csv('data/arrest_events_raw.csv', index=False) # Save csv to data folder